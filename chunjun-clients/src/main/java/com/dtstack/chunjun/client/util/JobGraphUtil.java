    ...
    public static JobGraph buildJobGraph(Options launcherOptions, String[] programArgs)
        ...
        PackagedProgram program =
                PackagedProgram.newBuilder()
                        ...
                        .build();
        JobGraph jobGraph;
        if (launcherOptions.getJobId() != null && launcherOptions.getJobId().trim().length() == 32) {
            // use the customize jobId generated by flink when jobId is not empty
            ...
            // use the jobId generated by flink when jobId is empty
            jobGraph = PackagedProgramUtils.createJobGraph(
                    program,
                    launcherOptions.loadFlinkConfiguration(),
                    flinkConf.getInteger(DEFAULT_PARALLELISM),
        ...
        if ("true".equals(launcherOptions.isRemote())) {
