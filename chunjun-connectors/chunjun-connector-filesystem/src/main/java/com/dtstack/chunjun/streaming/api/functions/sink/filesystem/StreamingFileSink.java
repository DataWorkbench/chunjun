 ...
 */
package com.dtstack.chunjun.streaming.api.functions.sink.filesystem;
 ...
 * StreamingFileSink#forRowFormat(Path, Encoder, Configuration)} or {@link
 * StreamingFileSink#forBulkFormat(Path, BulkWriter.Factory, Configuration)}.
 *
...
public class StreamingFileSink<IN> extends RichSinkFunction<IN>
     ...
     *     configured. In order to instantiate the sink, call {@link
     *     StreamingFileSink.RowFormatBuilder} after specifying the desired parameters.
     */
    public static <IN> StreamingFileSink.DefaultRowFormatBuilder<IN> forRowFormat(
            final Path basePath, final Encoder<IN> encoder, Configuration configuration) {
        return new StreamingFileSink.DefaultRowFormatBuilder<>(
                basePath, encoder, new DateTimeBucketAssigner<>(), configuration);
    }
     ...
     * @return The builder where the remaining of the configuration parameters for the sink can be
     *     configured. In order to instantiate the sink, call {@link
     *     StreamingFileSink.BulkFormatBuilder} after specifying the desired parameters.
     */
    public static <IN> StreamingFileSink.DefaultBulkFormatBuilder<IN> forBulkFormat(
        ...
        return new StreamingFileSink.DefaultBulkFormatBuilder<>(
                basePath, writerFactory, new DateTimeBucketAssigner<>(), configuration);
    }

    /**
     * The base abstract class for the {@link StreamingFileSink.RowFormatBuilder} and {@link
     * StreamingFileSink.BulkFormatBuilder}.
     */
    @Internal
    public abstract static class BucketsBuilder<
                    IN, BucketID, T extends StreamingFileSink.BucketsBuilder<IN, BucketID, T>>
    ...
    @PublicEvolving
    public static class RowFormatBuilder<
                    IN, BucketID, T extends StreamingFileSink.RowFormatBuilder<IN, BucketID, T>>
        ...
        public <ID>
                StreamingFileSink.RowFormatBuilder<
                                IN, ID, ? extends StreamingFileSink.RowFormatBuilder<IN, ID, ?>>
            ...
            return new StreamingFileSink.RowFormatBuilder(
                    basePath,
                    encoder,
        ...
        public StreamingFileSink<IN> build() {
            return new StreamingFileSink<>(this, bucketCheckInterval, configuration);
        }
        ...
        public BucketWriter<IN, BucketID> createBucketWriter() throws IOException {
            return new RowWiseBucketWriter<>(
                    FileSystem.getCustomUnguardedFileSystem(basePath.toUri(), configuration)
    ...
    public static final class DefaultRowFormatBuilder<IN>
            extends StreamingFileSink.RowFormatBuilder<
                    IN, String, StreamingFileSink.DefaultRowFormatBuilder<IN>> {
        ...
        private DefaultRowFormatBuilder(
                ...
                Configuration configuration) {
            super(basePath, encoder, bucketAssigner, configuration);
        }
    }
    ...
    public static class BulkFormatBuilder<
                    IN, BucketID, T extends StreamingFileSink.BulkFormatBuilder<IN, BucketID, T>>
            extends StreamingFileSink.BucketsBuilder<IN, BucketID, T> {
        ...
        public <ID>
                StreamingFileSink.BulkFormatBuilder<
                                IN, ID, ? extends StreamingFileSink.BulkFormatBuilder<IN, ID, ?>>
            ...
            return new StreamingFileSink.BulkFormatBuilder(
                    basePath,
                    writerFactory,
                    Preconditions.checkNotNull(assigner),
                    rollingPolicy,
    ...
    public static final class DefaultBulkFormatBuilder<IN>
            extends StreamingFileSink.BulkFormatBuilder<
                    IN, String, StreamingFileSink.DefaultBulkFormatBuilder<IN>> {
        ...
        private DefaultBulkFormatBuilder(
                ...
                Configuration configuration) {
            super(basePath, writerFactory, assigner, configuration);
        }
    }
