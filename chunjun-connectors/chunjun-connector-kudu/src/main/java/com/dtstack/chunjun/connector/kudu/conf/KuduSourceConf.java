 ...
 * @since 2021/6/17 星期四
 */
public class KuduSourceConf extends KuduCommonConf {
    ...
    public static KuduSourceConf from(ReadableConfig readableConfig) {

        KuduSourceConf conf =
                (KuduSourceConf) KuduCommonConf.from(readableConfig, new KuduSourceConf());
