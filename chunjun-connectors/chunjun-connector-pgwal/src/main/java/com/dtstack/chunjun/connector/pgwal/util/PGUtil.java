...
/** */
public class PGUtil {
    public static final String SLOT_PRE = "Chunjun_";
    public static final String DRIVER_NAME = "org.postgresql.Driver";
    public static final int RETRY_TIMES = 3;
    public static final int SLEEP_TIME = 2000;
    public static final String PUBLICATION_NAME = "chunjun_publication";
    ...
    public static ReplicationSlotInfoWrapper checkPostgres(
        ...
        try {
            ...
            if (count == 0L) {
                LOG.warn(
                        "no publication named [{}] existed, chunjun will create one",
                        PUBLICATION_NAME);
